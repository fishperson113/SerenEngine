...
namespace SerenEngine
{
	...
	class SEREN_API MemoryAllocator {
	public:
	...
	class SEREN_API LinearAllocator : public MemoryAllocator {
	public:
	...
	class SEREN_API StackAllocator : public MemoryAllocator {
		struct Header {
			uint8_t Padding;
		};
	public:
	...
	class SEREN_API PoolAllocator : public MemoryAllocator {
		struct FreeNode {
			FreeNode* Next;
		};
	public:
