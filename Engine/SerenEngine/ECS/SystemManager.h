	...
	namespace ECS {
		...
		public:
			...
			T& AddSystem(Args&&... args) {
				BASE_CLASS_ASSERT(ISystem, T, "Add not valid system type");
			...
			void AddSystemDependency(T* target, Dependency* dependency) {
				BASE_CLASS_ASSERT(ISystem, T, "Not valid system target type");
				BASE_CLASS_ASSERT(ISystem, Dependency, "Not valid system dependency type");
